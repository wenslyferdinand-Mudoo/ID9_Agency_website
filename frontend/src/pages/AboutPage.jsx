    ...
    <main data-testid="about-page" className="pt-32 md:pt-40 pb-0">
      <section className="relative px-4 md:px-8 pb-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <p className="text-orange_impact font-ui text-xs uppercase tracking-[0.3em] mb-6 inline-flex items-center gap-2">
            <Sparkles className="w-3 h-3" /> About ID9
          </p>
          <RevealText
            as="h1"
            text="A studio built around craft, clarity and consequence."
          ...
          <p className="mt-10 max-w-3xl font-inter text-lg md:text-xl text-white/70 leading-relaxed">
            Since {BRAND.founded}, ID9_AGENCY has been quietly shaping the digital ecosystems
            behind some of the most distinctive brands in the Caribbean, North America and
            Europe. We work as a single integrated studio — strategy, design, build, motion
            and growth — so your brand moves in lockstep instead of fighting handoffs.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-10 items-center">
          ...
          <div className="md:col-span-6">
            ...
            <blockquote className="font-display text-3xl md:text-4xl font-black tracking-tighter leading-[1.05] text-balance">
              "Impact always starts with an idea — but it only becomes real when craft,
              strategy and timing collide."
            </blockquote>
            <p className="mt-8 font-inter text-white/70 leading-relaxed">
              Wensly is a designer, entrepreneur, digital strategist and creative director.
              He started ID9 because he was tired of agencies that talked premium but
              delivered template. Today he leads a small, senior studio committed to a single
              promise: every brand we touch leaves visibly stronger than we found it.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 md:px-8 py-28">
        <div className="max-w-7xl mx-auto">
          ...
          <RevealText
            as="h2"
            text="Seven years of compounding craft."
            ...
            {TIMELINE.map((t, i) => (
              ...
              >
                ...
                <div className="col-span-9 md:col-span-10">
                  ...
                  <p className="text-white/65 mt-2 font-inter leading-relaxed">{t.d}</p>
                </div>
              </motion.li>
            ))}
          </ul>
