      ...
      <motion.div style={{ y, opacity }} className="relative max-w-7xl mx-auto">
        ...
        >
          <span className="inline-flex items-center gap-2 glass rounded-full px-4 py-1.5 text-xs font-ui uppercase tracking-[0.2em] text-white/80">
            ...
            New clients · 2026 roster open
          </span>
        </motion.div>

        <h1 className="font-display font-black tracking-[-0.04em] leading-[1] text-[clamp(2.4rem,7.5vw,7rem)] text-balance">
          <RevealText as="span" text="Be Impactful." className="block" />
          <RevealText as="span" text="Build" className="block" delay={0.2} />
          <motion.span
          ...
          <RevealText as="span" text="Digital Brands." className="block" delay={0.55} />
        </h1>
        ...
        >
          ID9_AGENCY transforms ambitious ideas into premium digital ecosystems — branding,
          web, marketing & media production engineered for visibility, credibility and growth.
        </motion.p>
